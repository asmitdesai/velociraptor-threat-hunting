...
**Target Audience:** Cybersecurity Recruiters / SOC Managers
...
| --- | --- | --- | --- |
| DFIR-Server | Ubuntu 24.04 LTS (arm64) | Velociraptor Server | 10.211.55.10 |
| Win11-Endpoint | Windows 11 Pro (arm64) | Target/Client | 10.211.55.11 |
...
Within the Velociraptor GUI (`https://10.211.55.10:8889`), the `Server.Utils.CreateMSI` artifact was utilized to generate a pre-configured ARM64/x64 installer.
...
2.  **On Windows 11 Endpoint (Target):**
    ...
    Open Command Prompt as Administrator and run:
        ...
        msiexec /i [http://10.211.55.10:8080/vel.msi](http://10.211.55.10:8080/vel.msi) /qn
